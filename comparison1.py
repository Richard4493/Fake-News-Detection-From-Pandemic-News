...
class Compare:
    ...
    def __init__(self):
        ...
        logging.info('SVM  Implemented')
        pipe3 = Pipeline([('tfidf', TfidfVectorizer()),
                          ('model', RandomForestClassifier(random_state=0))])
        RF=pipe3.fit(X_train,y_train)
        ...
        logging.info('Random Forest Implemented')
        pipe4 = Pipeline(
            [('tfidf', TfidfVectorizer()), ('model', DecisionTreeClassifier(random_state=0))])
        DT=pipe4.fit(X_train, y_train)
